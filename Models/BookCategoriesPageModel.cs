...
namespace Sulea_Steliana_Lab2.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Sulea_Steliana_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Sulea_Steliana_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
