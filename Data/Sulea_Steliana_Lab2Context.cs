...
namespace Sulea_Steliana_Lab2.Data
{
    public class Sulea_Steliana_Lab2Context : DbContext
    {
        ...
        public DbSet<Sulea_Steliana_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Sulea_Steliana_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Sulea_Steliana_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
